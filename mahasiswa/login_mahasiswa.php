  ...
  <body>
    ...
    <div class="container">
      <div class="card login-form" style="height:450px;">
        ...
        <form class="row g-3 needs-validation" action="proses_login_mahasiswa.php" method="post">
          
          <div class="col-12">
            <label for="validationCustomUsername" class="form-label">Nomor Induk Mahasiswa (NIM)</label>
            <div class="input-group has-validation">
              <span class="input-group-text" id="inputGroupPrepend">@</span>
              <input type="text" name="nim" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
